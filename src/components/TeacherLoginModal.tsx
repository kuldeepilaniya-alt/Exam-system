      ...
      >
        ...
        <div className="mt-4 pt-3.5 border-t border-slate-100">
          <p className="text-[11px] text-center font-medium text-slate-400 mb-2">
            Or connect with school Google account for live Sheets sync
          </p>
          <button
            type="button"
            ...
            className="w-full flex items-center justify-center gap-2.5 rounded-xl border border-slate-200 bg-white py-2.5 px-3 text-xs font-bold text-slate-700 shadow-xs hover:bg-slate-50 transition"
          >
            ...
            {isGoogleLoading ? 'Connecting...' : 'Sign in with Google (Sheets sync)'}
          </button>
        </div>
      </div>
    </div>
